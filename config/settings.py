...
SECRET_KEY = 'django-insecure-i80_-$%+lh7)&ud**v3l@s1iq&!-h2&mbqtyv=@k%s_t7@m)*r'
...
INSTALLED_APPS = [
    ...
    'english',
    "ckeditor",
    "ckeditor_uploader",  # если хочешь загрузку картинок
]
...
CKEDITOR_UPLOAD_PATH = "uploads/" # Redaktor arqalı júklengen fayllar media papkası ishinde qayda saqlanadı
CKEDITOR_CONFIGS = {
    'default': {
...
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "KEY_PREFIX": "english_app_",  # Префикс для всех ключей
                    },
        "TIMEOUT": 300,  # кэш на 5 минут
    }
}
